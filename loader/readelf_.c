...
{
//     if (bytecmpq(global_quiet, "no") == 0) printf("received signal (%d)\n", sig);
    if (sig == SIGSEGV)
    {
        if (bytecmpq(global_quiet, "no") == 0) printf("\r    NOTICE\n");
        void * h_ = &Handlerb;
        if (bytecmpq(global_quiet, "no") == 0) printf("    received SegFault (%d)\n", sig);
        if (bytecmpq(global_quiet, "no") == 0) printf("    addr:   %014p\n", si->si_addr);
        if (bytecmpq(global_quiet, "no") == 0) printf("    arch:   %d\n", si->si_arch);
        if (bytecmpq(global_quiet, "no") == 0) printf("    signo:  %d\n", si->si_signo);
        if (bytecmpq(global_quiet, "no") == 0) printf("    errno:  %d\n", si->si_errno);
        if (bytecmpq(global_quiet, "no") == 0) printf("    code:   %d (If this is less than or equal to 0, then the signal was generated by a process)\n", si->si_code);
        if (bytecmpq(global_quiet, "no") == 0) printf("    pid:    %d\n", (pid_t) si->si_pid);
        if (bytecmpq(global_quiet, "no") == 0) printf("    uid:    %d\n", (uid_t) si->si_uid);
        if (bytecmpq(global_quiet, "no") == 0) printf("    value:  %d\n", (sigval_t) si->si_value);
        if (bytecmpq(global_quiet, "no") == 0) printf("    status: %d\n", si->si_status);
        if (bytecmpq(global_quiet, "no") == 0) printf("    aquiring ucontext_t\n");
        getcontext(unused);
        signal(SIGSEGV, h_);
...
//     if (bytecmpq(global_quiet, "no") == 0) printf("                                                                                                                        received signal (%d)\n", sig);
    if (sig == SIGSEGV)
    {
//         if (bytecmpq(global_quiet, "no") == 0) printf("NOTICE\n");
        void * h = &Handler;
//         if (bytecmpq(global_quiet, "no") == 0) printf("received SegFault (%d)\n", sig);
//         if (bytecmpq(global_quiet, "no") == 0) printf("addr:   %014p\n", si->si_addr);
//         int fault_code = setjmp(restore_pointb);
//         if (fault_code == 0) if (bytecmpq(global_quiet, "no") == 0) printf("arch:   %d\n", si->si_arch);
//         else  if (bytecmpq(global_quiet, "no") == 0) printf("arch:   NULL (recovered from a fault, code = %d)\n", fault_code);
//         if (bytecmpq(global_quiet, "no") == 0) printf("signo:  %d\n", si->si_signo);
//         if (bytecmpq(global_quiet, "no") == 0) printf("errno:  %d\n", si->si_errno);
//         if (bytecmpq(global_quiet, "no") == 0) printf("code:   %d (If this is less than or equal to 0, then the signal was generated by a process)\n", si->si_code);
//         if (bytecmpq(global_quiet, "no") == 0) printf("pid:    %d\n", (pid_t) si->si_pid);
...
//         if (bytecmpq(global_quiet, "no") == 0) printf("status: %d\n", si->si_status);
//         if (bytecmpq(global_quiet, "no") == 0) printf("aquiring ucontext_t\n");
//         if (bytecmpq(global_quiet, "no") == 0) printf("Address of crash:          %x\n",context->uc_mcontext.gregs[REG_RIP]);
//  RAX  0xbc748
//  RBX  0x2
...
//         if (bytecmpq(global_quiet, "no") == 0) printf("RAX:                       %x\n",context->uc_mcontext.gregs[REG_RAX]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("RBX:                       %x\n",context->uc_mcontext.gregs[REG_RBX]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("RCX:                       %x\n",context->uc_mcontext.gregs[REG_RCX]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("RDX:                       %x\n",context->uc_mcontext.gregs[REG_RDX]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("RDI:                       %x\n",context->uc_mcontext.gregs[REG_RDI]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("RSI:                       %x\n",context->uc_mcontext.gregs[REG_RSI]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("R8:                        %x\n",context->uc_mcontext.gregs[REG_R8]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("R9:                        %x\n",context->uc_mcontext.gregs[REG_R9]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("R10:                       %x\n",context->uc_mcontext.gregs[REG_R10]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("R11:                       %x\n",context->uc_mcontext.gregs[REG_R11]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("R12:                       %x\n",context->uc_mcontext.gregs[REG_R12]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("R13:                       %x\n",context->uc_mcontext.gregs[REG_R13]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("R14:                       %x\n",context->uc_mcontext.gregs[REG_R14]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("R15:                       %x\n",context->uc_mcontext.gregs[REG_R15]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("RBP:                       %x\n",context->uc_mcontext.gregs[REG_RBP]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("RSP:                       %x\n",context->uc_mcontext.gregs[REG_RSP]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("RIP:                       %x\n",context->uc_mcontext.gregs[REG_RIP]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("EFL:                       %x\n",context->uc_mcontext.gregs[REG_EFL]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("CSGSFS:                    %x\n",context->uc_mcontext.gregs[REG_CSGSFS]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("ERR:                       %x\n",context->uc_mcontext.gregs[REG_ERR]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("TRAPNO:                    %x\n",context->uc_mcontext.gregs[REG_TRAPNO]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("OLDMASK:                   %x\n",context->uc_mcontext.gregs[REG_OLDMASK]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("CR2:                       %x\n",context->uc_mcontext.gregs[REG_CR2]);
//         context->uc_mcontext.gregs[REG_RIP] = context->uc_mcontext.gregs[REG_RIP] + 0x02 ;
//         if (bytecmpq(global_quiet, "no") == 0) printf("Next Address:              %x\n",context->uc_mcontext.gregs[REG_RIP]);
        signal(SIGSEGV, h);
...
int testh(char * address)
{
    ...
    if (fault_code == 0)
    {
        ...
        */
        if (bytecmpq(global_quiet, "no") == 0) printf("value: %15x\t", *(int*)address);
        return 0;
    }
    else
    {
        if (bytecmpq(global_quiet, "no") == 0) printf("value: %s\t", "     is not hex");
        return -1;
    }
}
...
//         __lseek_string__(&tmp99, info->dlpi_phdr[j].p_memsz, info->dlpi_phdr[j].p_offset);
        ...
        if (bytecmpq(global_quiet, "no") == 0) printf("\t\t p_offset:\t\t/* Segment file offset */\t= %014p\n", info->dlpi_phdr[j].p_offset);
        if (bytecmpq(global_quiet, "no") == 0) printf("\t\t p_vaddr:\t\t/* Segment virtual address */\t= %014p\n", info->dlpi_phdr[j].p_vaddr);
        if (bytecmpq(global_quiet, "no") == 0) printf("\t\t p_paddr:\t\t/* Segment physical address */\t= %014p\n", info->dlpi_phdr[j].p_paddr);
        if (bytecmpq(global_quiet, "no") == 0) printf("\t\t p_filesz:\t\t/* Segment size in file */\t= %014p\n", info->dlpi_phdr[j].p_filesz);
        if (bytecmpq(global_quiet, "no") == 0) printf("\t\t p_memsz:\t\t/* Segment size in memory */\t= %014p\n", info->dlpi_phdr[j].p_memsz);
        if (bytecmpq(global_quiet, "no") == 0) printf("\t\t p_align:\t\t/* Segment alignment */\t\t= %014p\n", info->dlpi_phdr[j].p_align);
...
int __stream__(char *file, char **p, int *q, int LINES_TO_READ) {
            ...
            if (bytecmpq(global_quiet, "no") == 0) printf("\rbytes read: %'i", bytes);
                if (count == 1024) { array_tmp = realloc(array, bytes+1024);
                    if (array_tmp == NULL) {
                        if (bytecmpq(global_quiet, "no") == 0) printf("failed to allocate array to new size");
                        free(array);
                        exit(1);
                    } else {
                        array = array_tmp;
            ...
            if (bytecmpq(global_quiet, "no") == 0) printf("\rbytes read: %'i\n", bytes);
    *p = array;
    *q = bytes;
    return bytes;
}
...
int __streamb__(char *file, char **p, int *q, int LINES_TO_READ) {
            ...
            if (bytecmpq(global_quiet, "no") == 0) printf("\rbytes read: %'i", bytes);
                ...
                array[bytes-1] = ch;
                if (ch == '\n') {
                    if (bytecmpq(global_quiet, "no") == 0) printf("attempting to reset array\n");
                    if (lines == LINES_TO_READ) {
                        break;
                    } else {
...
int __readb__(char *file, char **p, size_t *q) {
    ...
    int cl = close(fd);
    if (cl < 0) {
        if (bytecmpq(global_quiet, "no") == 0) printf("cannot close \"%s\", returned %i\n", file, cl);
        return -1;
    }
    *p = o;
    *q = len;
...
//   Elf64_Xword	st_size;		/* Symbol size */
    for(int i=0; i< 40; i++) {
        ...
        if (bytecmpq(global_quiet, "no") == 0) printf("size: %d \t", sym_tbl[i].st_size);
...
// #define STV_PROTECTED	3		/* Not preemptible, not exported */
        ...
        if ( ELF64_ST_TYPE(sym_tbl[i].st_info) == STT_FUNC)
            if (bytecmpq(global_quiet, "no") == 0) printf("address: %014p\t", sym_tbl[i].st_value+mappingb+align);
        else
            if (bytecmpq(global_quiet, "no") == 0) printf("address: %014p\t", sym_tbl[i].st_value+mappingb);
        if (bytecmpq(global_quiet, "no") == 0) printf("name: [Not obtained due to unavailability]\n");
    }
}
...
{
//     for(int i=0; i<eh->e_shnum; i++) {
        if (bytecmpq(global_quiet, "no") == 0) printf("print_symbols_lookup: trying index %d\n", 10);
...
void * lookup_symbol_by_index(const char * arrayb, Elf64_Ehdr * eh, int symbol_index, int mode) {
        if (bytecmpq(global_quiet, "no") == 0) printf("attempting to look up symbol, index = %d\n", symbol_index);
...
//         if (bytecmpq(global_quiet, "no") == 0) printf("address of GOT[1] = %014p\n", GOT[1]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("address of GOT[2] = %014p\n", GOT[2]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("address of GOT[3] = %014p\n", GOT[3]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("address of GOT[4] = %014p\n", GOT[4]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("address of GOT[5] = %014p\n", GOT[5]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("address of GOT[6] = %014p\n", GOT[6]);
//         if (bytecmpq(global_quiet, "no") == 0) printf("address of GOT[7] = %014p\n", GOT[7]);
        char * symbol = print_symbols_lookup(arrayb, eh, _elf_symbol_table, symbol_index, mode);
        if (bytecmpq(global_quiet, "no") == 0) printf("symbol = %d (%014p)\n", symbol, symbol);
        return symbol;
}
...
init_(const char * filename) {
    ...
    if(!strncmp((char*)_elf_header->e_ident, "\177ELF", 4)) {
        ...
        if (PT_DYNAMIC_ != 0) {
            ...
            r_init();
            r(mappingb + get_dynamic_entry(dynamic, DT_RELA), get_dynamic_entry(dynamic, DT_RELASZ), "yes");
            r(mappingb + get_dynamic_entry(dynamic, DT_JMPREL), RELA_PLT_SIZE, "yes");
            r_summary();
        }
    } else return -1;
    init__ = 1;
...
//
            if (bytecmpq(global_quiet, "no") == 0) printf("Name:\t\t %s\n", filename);
            if (bytecmpq(global_quiet, "no") == 0) printf("ELF Identifier\t %s (", _elf_header->e_ident);
...
// continue analysis
            for (int i = 0; i < _elf_header->e_phnum; ++i) {
                ...
                if (bytecmpq(global_quiet, "no") == 0) printf("ATTEMPING TO READ\n");
...
_elf_header->e_shoff = %014p)\n",\
            ...
            print_symbols(array, _elf_header, _elf_symbol_table);
                ...
                /* Not ELF file */
                if (bytecmpq(global_quiet, "no") == 0) printf("ELFMAGIC not found\n");
